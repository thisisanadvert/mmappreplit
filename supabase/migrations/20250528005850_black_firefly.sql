/*
  ...
  1. Changes
    - Create helper functions with SECURITY DEFINER to safely access auth schema
    - Simplify building creation policy to avoid raw_user_meta_data references
    - Fix building_users policy to allow first-time associations
    - Update handle_new_user_signup function to properly bypass RLS
*/
...
-- This avoids any references to auth.users or raw_user_meta_data
