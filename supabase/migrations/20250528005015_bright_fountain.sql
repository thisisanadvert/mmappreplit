/*
  ...
  1. Changes
    - Create simplified policies for building creation
    - Fix building_users policies to allow first-time associations
    - Prevent circular dependencies in RLS policies
    - Add helper functions with SECURITY DEFINER to bypass RLS

  2. Security
    - Maintain existing security model
    - Allow new users to create their first building
